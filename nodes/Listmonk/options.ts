...
export const listmonkOptions: INodeProperties[] = [
	...
	},
	{
		...
		displayOptions: {
			show: {
				operation: ['createTemplate', 'modifyTemplate', 'createSubscriber', 'modifySubscriber'],
			},
		},
	},
	{
		...
		displayOptions: {
			show: {
				operation: ['createTemplate', 'modifyTemplate'],
			},
		},
	},
	{
	...
	},
	{
		...
		displayOptions: {
			show: {
				operation: ['createList', 'updateList', 'createCampaign', 'updateCampaign', 'testCampaign'],
			},
		},
	},
	{
	...
	},
	{
		...
		displayOptions: {
			show: {
				operation: ['sendTx', 'modifySubscriber'],
			},
		},
	},
	{
	...
	////
	{
		...
		displayOptions: {
			show: {
				operation: ['createSubscriber', 'modifySubscriber'],
			},
		},
	},
	{
	...
	},
	{
		...
		description:
			'Whether If true, subscriptions are marked as confirmed and no-optin emails are sent for double opt-in lists',
		displayOptions: {
			show: {
				operation: ['createSubscriber', 'modifySubscriber'],
			},
